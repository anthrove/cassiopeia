...
func main() {
	clientID := "R09o0StXZeC298S6aB9fkexbF"
	clientSecret := "4j9rpu9Lb0eOEJ54xATJ_vp9-O0ST0CNxDZMaJ0hDjAQp-25E8"
	keyPath := os.Getenv("KEY_PATH")
	issuer := "http://192.168.1.15:8080/_90M8A_RRUKPT1vPgjiqcmrPB"
	port := "8081"
